...
from utils.torch_utils import _save_checkpoint
...
class TrainFramework(BaseTrainer):
    ...
    def _run_one_epoch(self):
        ...
        for i_step, data in enumerate(self.train_loader):
            ...
            if self.cfg.run_atst:
                ...
                copy_s = deepcopy(s)
                st_res = self.sp_transform(copy_s) if self.cfg.run_st else deepcopy(s)
            ...
            scaled_loss = 1024. * loss  # single precision
    ...
    def _validate_with_gt(self):
        ...
        if self.i_iter > self.cfg.save_iter:
            ...
            self.save_model('EPE', name=str(self.i_iter))
            # _save_checkpoint(self.model, os.path.join('/home/hulk/Workspace/nick/ARFlow/outputs/checkpoints', 'symm', 'step_%06d.pth' % (self.i_iter + 1)))
